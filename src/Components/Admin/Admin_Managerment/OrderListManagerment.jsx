...
const OrderListManagerment = () => {
  ...
  const fetchOrders = async (page = currentPage) => {
    setLoading(true);
    try {
      const data = await getAllPendingOrder(page, itemsPerPage);
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              <p className="text-balance">
                Do you want to change the order status from PENDING to
                CONFIRMED?
              </p>
            </Form.Group>
          </Form>
...
export default OrderListManagerment;
