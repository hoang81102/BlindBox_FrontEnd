...
const OrderDeliveryManagerment = () => {
  ...
  const fetchOrders = async (page = currentPage) => {
    setLoading(true);
    try {
      const data = await getAllDeliveredOrder(page, itemsPerPage);
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              <p className="text-balance">
                Do you want to change the order status from DELIVERED to
                COMPLETED?
              </p>
            </Form.Group>
          </Form>
...
export default OrderDeliveryManagerment;
